...
*fixing common data quality errors and converting string variables into numeric variables first (inconsistent data types). We did noy convert all strings into numerics but as a result, we have less observartions and variables in red
...
*creating a transformation of variables by transforming them into categories (bins) by 1 being a "low number of beds", 2 is "medium number of beds", and 3 is "high number of beds" - categorical transformation (one of the types) 
